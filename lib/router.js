...
Router.map(function() {
    ...
    this.route('signupInstructor', {
        path: '/inscription/instructeur'
    });
    ...
    this.route('studentPaymentForm', {
        path: '/eleve/achat-licence'
    });
...
Layouts = [
    ...
    },
    {
        ...
        // where to use
        routes: ['studentDashboard', 'studentPaymentForm']
    }
];
...
Router.onBeforeAction(IR_BeforeHooks.loginRequired, {
    except: ['login', 'signupStudent', 'home']
});
